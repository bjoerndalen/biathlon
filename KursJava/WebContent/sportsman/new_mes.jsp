...
<div class="container">
  ...
  <%
  Collection<Referee> ref_list = ServiceFactory.DEFAULT.getRefereeService().getAllEntites();
  pageContext.setAttribute("ref_list", ref_list);
  %>
  <p><b>Кому:</b><br>
		<select name="whomname">
		<c:forEach var="buf" items="${ref_list}">
